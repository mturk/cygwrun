...
rv="`$_cygwrun -p --I=/tmp/foo`"
test "x$rv" = "x--I=$tmpdir\\foo" || xbexit 1 "Failed #7.6: \`$rv'"
rv="`$_cygwrun -p I=/tmp/foo:/tmp/bar`"
test "x$rv" = "xI=$tmpdir\\foo;$tmpdir\\bar" || xbexit 1 "Failed #7.7: \`$rv'"
rv="`$_cygwrun -p I=\"\\\"./tmp\"\\\"`"
test "x$rv" = "xI=\".\\tmp\"" || xbexit 1 "Failed #7.8: \`$rv'"
rv="`$_cygwrun -p I=\"\\\"./tmp:./bar\"\\\"`"
test "x$rv" = "xI=\".\\tmp;.\\bar\"" || xbexit 1 "Failed #7.9: \`$rv'"
